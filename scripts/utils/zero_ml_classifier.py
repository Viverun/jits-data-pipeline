# scripts/utils/zero_ml_classifier.py - HARDENED VERSION
import re
...
class ZeroMLClassifier:
    ...
    # ---- 1. CAUSE TITLE AUTHORITY (Takes Precedence) ----
    ...
    # ---- 2. SIGNAL LISTS (for 2-of-3 rule) ----
    # Procedural Verbs (Strong Context)
    PROCEDURAL_VERBS = {"apply", "invoke", "grant", "reject", "quash", "uphold", "set aside", "remand"}

    # Substantive Keywords (Weak Signal)
    ...
    # Section Patterns (Strong Signal)
    ...
    def _apply_2_of_3_rule(self, signals: Dict) -> Tuple[str, str, List[str]]:
        ...
        The three factors are: 1) Sections, 2) Keywords, 3) Procedural Verbs.
        """
        reasoning = []
